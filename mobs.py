...
for guid, obj in objs_by_guid.items():
    if "IsAggressive" not in obj or obj["IsAggressive"]:
        continue
...
'''{name}''' is a [[:Category:Friendly Mobs|brown]] [[Cards|Card]] in [[Stacklands]]. In the [[Cardopedia]], it is categorized as a [[:Category:Mobs|Mob]].

{spawn}\
{gear}\
{drops}\
[[Category:Mobs]]
[[Category:Friendly Mobs]]"""
